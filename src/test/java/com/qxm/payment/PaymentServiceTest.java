...
public class PaymentServiceTest {
    ...
    public void testCreateClient() throws Exception
    {
    	...
    	Optional<Client> client = paymentService.findClientByName("Alice");
    	...
    	client = paymentService.findClientByName("Bob");
    	assertEquals(false, client.isPresent());
    	...
    	Client alice1 = paymentService.findClientByName("Alice").get();
